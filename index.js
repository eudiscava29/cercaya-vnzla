...
// Función auxiliar para leer cookies básicas de los headers de la petición
...
// Determina si el usuario actual debe ver el sandbox (basado en su cookie privada)
  ...
  let listHtml = usersList.map(u => `
    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4 mb-3 space-y-3">
      <div class="flex justify-between items-start">
        ...
        <span class="bg-emerald-100 text-emerald-800 text-[10px] font-black px-2.5 py-1 rounded-full uppercase">${u.status}</span>
      </div>
