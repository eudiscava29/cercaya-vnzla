...
// Conexión a Turso utilizando @libsql/client con adaptador compatible para mantener toda la lógica
...
const pool = {
  async query(text, params = []) {
    ...
    // Adaptador para transformar la sintaxis ANY de PostgreSQL a IN (...) compatible con SQLite/Turso
...
async function conectarDB() {
  try {
    ...
    console.log("🚀 Conectado exitosamente a Turso (libSQL)");
  } catch (e) {
    console.error("Error al conectar con Turso:", e);
  }
}
...
app.listen(PORT, '0.0.0.0', () => { console.log(`🚀 CercaYa con Turso activo en puerto ${PORT}`); });
